...
public class ShareLoaderActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_share_loader);
                    ...
                    .subscribe(new SingleObserver<YouTubeExtractionResult>() {
                        ...
                        public void onSuccess(final YouTubeExtractionResult value) {
                            ...
                            try {
                                if (value.getSd240VideoUri() != null) {
                                    ...
                                    buttonQuality240.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            ...
                                            startActivity(Intent.createChooser(intent, Const.SHARE_CHOSER_TEXT));
                                        }
                                    });
                                } else {
                                ...
                                Toast.makeText(ShareLoaderActivity.this, "Youtube url fetching error.", Toast.LENGTH_SHORT).show();
                                progressBar.setVisibility(View.GONE);
                                e.printStackTrace();
                                finish();
                            }
